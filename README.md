...
* You need to provide the URL to the folder you created earlier in you server to the CodeNameOneFileUploader JAVA API as serverURL in the constructor.<br/>(exemple: "localhost/foldername")
