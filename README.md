...
### Usage:
* The JAR file provided should be included as a library in your CodeNameOne project

* You need to provide the URL to the folder you created earlier in your server to the CodeNameOneFileUploader JAVA API as serverURL in the constructor.<br/>(exemple: "localhost/foldername")
